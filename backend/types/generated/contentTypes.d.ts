...
export interface ApiMaintenanceMaintenance extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Manages repair and maintenance tickets for devices.';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    problem_description: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    start_date: Schema.Attribute.DateTime & Schema.Attribute.DefaultTo<'NOW'>;
    status: Schema.Attribute.Enumeration<
...
export interface ApiSupplierSupplier extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Suppliers for purchase orders and inventory acquisition';
