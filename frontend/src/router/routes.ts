...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'suppliers', component: () => import('pages/SuppliersPage.vue'), meta: { requiresAuth: true } },
      { path: 'purchase-orders', component: () => import('pages/PurchaseOrdersPage.vue'), meta: { requiresAuth: true } },
      { path: 'chart-of-accounts', component: () => import('pages/ChartOfAccountsPage.vue'), meta: { requiresAuth: true } },
      { path: 'journal-entries', component: () => import('pages/JournalEntriesPage.vue'), meta: { requiresAuth: true } },
...

  {
    ...
    children: [
      ...
      { path: 'printing', component: () => import('pages/PrintingSettings.vue'), meta: { requiresAuth: true } },
      { path: 'user-roles', component: () => import('pages/UserRoleSettings.vue'), meta: { requiresAuth: true } },
      { path: 'integrations', component: () => import('pages/IntegrationSettings.vue'), meta: { requiresAuth: true } },
